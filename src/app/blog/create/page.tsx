...
export default function BlogCreatePage() {
  ...
  return (
    <form action={formAction}>
      <div className="">
        <input type="text" name="title" placeholder="タイトルを入力してください。" className="w-full border border-black-400 rounded" />
        <input type="text" name="tag" placeholder="タグを入力してください。スペース区切りで入力できます。" className="w-full border border-black-400 rounded" />
      </div>
      <div className="flex border border-black-400">
            ...
            <div className="w-full mb-4 border border-default-medium rounded-base bg-neutral-secondary-medium shadow-xs">
              <div className="px-2 py-1 bg-neutral-secondary-medium rounded-t-base">
                ...
                <textarea 
                  ...
                  name="context"
                  id="comment" rows={21} className="block w-full px-0 text-sm text-heading bg-neutral-secondary-medium border-0 focus:ring-0 placeholder:text-body" placeholder="Write a context..." required ></textarea>
              </div>
              <div className="flex items-center px-3 py-2 border-t border-default-medium">
                ...
                <div className="flex ps-0 space-x-1 rtl:space-x-reverse sm:ps-2">
                  <label className="relative inline-block w-11 h-6 cursor-pointer">
                    <input type="checkbox" id="hs-basic-usage" name="isPublic" className="peer sr-only" 
                    value="true"onChange={(e) => setPublicState(e.target.checked ? '公開' : '非公開')} />
        ...
        <div className="w-1/2 h-122 overflow-y-auto border border-black-400">
          <div className="prose">
